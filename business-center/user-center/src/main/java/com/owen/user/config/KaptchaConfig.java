...
public class KaptchaConfig {
    ...
    public DefaultKaptcha producer() {
        ...
        properties.put(KAPTCHA_IMAGE_HEIGHT, "66");
        properties.put(KAPTCHA_IMAGE_FONT_SIZE, "50");
        properties.put(KAPTCHA_TEXTPRODUCER_CHAR_LENGTH, "4");
        properties.setProperty("kaptcha.textproducer.font.names", "new Font(\"Arial\", 1, fontSize), new Font(\"Courier\", 1, fontSize)");
