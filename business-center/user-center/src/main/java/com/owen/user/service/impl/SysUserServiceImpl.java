...
import com.owen.common.constant.UserType;
...
import com.owen.common.util.PageUtil;
import com.owen.common.util.SysUserUtil;
import com.owen.common.util.ValidatorUtil;
...
import com.owen.user.service.SysPermissionService;
import com.owen.user.service.SysUserService;
...
import com.owen.user.dao.SysUserDao;
...
public class SysUserServiceImpl implements SysUserService {
	...
	public PageResult<SysUser> findUsers(Map<String, Object> params)  throws ServiceException {
		try {
			...
			if (total > 0) {
				PageUtil.startPage(Integer.parseInt((String) params.get("page")),Integer.parseInt((String)params.get("limit")));
	...
	public Result saveOrUpdate(SysUser sysUser)  throws ServiceException {
		try {
			...
			if (sysUser.getId() == null) {
				...
				sysUser.setUpdateTime(sysUser.getCreateTime());
				i = sysUserDao.insertUser(sysUser);
			} else {
				sysUser.setUpdateTime(new Date());
